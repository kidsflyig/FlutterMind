import 'package:FlutterMind/third_party/auto_size_text/auto_size_group.dart';
...
class AutoSizeTextState extends State<AutoSizeText> {
  ...
  List _calculateFontSize(
    ...
    final presetFontSizes = null;//widget.presetFontSizes?.reversed.toList();
